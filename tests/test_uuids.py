...
from mojang_api.api import get_uuid
...
def test_uuids():
    empirical_username_uuid_pairs = [(username_uuid_pair[0], get_uuid(
        username_uuid_pair[0])['id']) for username_uuid_pair in USERNAME_UUID_PAIRS]
